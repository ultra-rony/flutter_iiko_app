...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductInfoState);
}
...
/// @nodoc
class $ProductInfoStateCopyWith<$Res>  {
$ProductInfoStateCopyWith(ProductInfoState _, $Res Function(ProductInfoState) __);
}


/// Adds pattern-matching-related methods to [ProductInfoState].
extension ProductInfoStatePatterns on ProductInfoState {
...
class _Initial implements ProductInfoState {
  const _Initial();
...
@override
String toString() {
  return 'ProductInfoState.initial()';
}
